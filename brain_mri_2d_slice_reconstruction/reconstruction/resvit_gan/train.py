...
DEFAULT_OUTPUT_DIR = MODEL_DIR / "checkpoints" / "resvit_gan"
MODEL_NAME = "resvit_gan"
MODEL_TITLE = "ResViT-GAN"


def parse_args():
    parser = argparse.ArgumentParser(description="Train ResViT-GAN for 2D brain MRI synthesis.")
    parser.add_argument("--data-dir", default=str(DEFAULT_DATA_DIR))
    parser.add_argument("--output-dir", default=str(DEFAULT_OUTPUT_DIR))
    parser.add_argument("--max-epochs", "--epochs", dest="max_epochs", type=int, default=220)
    parser.add_argument("--batch-size", type=int, default=4)
    parser.add_argument("--num-workers", type=int, default=2)
    parser.add_argument("--generator-learning-rate", type=float, default=1.5e-4)

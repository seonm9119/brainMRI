...
from brain_mri_2d_slice_reconstruction.reconstruction.training import run_training
...
DEFAULT_OUTPUT_DIR = MODEL_DIR / "checkpoints" / "mamba_conv_unet"
MODEL_NAME = "mamba_conv_unet"
MODEL_TITLE = "Mamba-Conv U-Net"


def parse_args():
    parser = argparse.ArgumentParser(description="Train Mamba-Conv U-Net for 2D brain MRI synthesis.")

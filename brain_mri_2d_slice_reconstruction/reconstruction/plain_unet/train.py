...
DEFAULT_OUTPUT_DIR = MODEL_DIR / "checkpoints" / "plain_unet"
MODEL_NAME = "plain_unet"
MODEL_TITLE = "Plain U-Net"


def parse_args():
    parser = argparse.ArgumentParser(description="Train plain U-Net for 2D brain MRI synthesis.")
